                    ...
                    <form>
                        <div class="card mb-4 ">
                            <div class="card-body overflow-auto">
                                ...
                                <div class="section-item" style="display: none;">
                                    <!-- MEDICAL Accident -->
                                    <div class="section-item-medical" data="required" style="display: none;">
                                        <div class="card shadow">
                                            <div class="card-header">
                                                <h6 class="m-0 font-weight-bold text-primary">Type of Medical Accident</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="row d-flex justify-content-center">

                                                    <div class="medical-item active col-xl-3 col-md-4 col-sm-6 p-0 m-1"
                                                        data-item-id="1"
                                                        style="cursor:pointer;">
                                                        <div class="card border-left-primary shadow user-select-none">
                                                            <div class="card-body">
                                                                <div class="row no-gutters align-items-center">
                                                                    <div class="col mr-2">
                                                                        <div
                                                                            class="text-xs font-weight-bold text-uppercase mb-1">
                                                                            Motor vehicle accident victims</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="medical-item col-xl-3 col-md-4 col-sm-6 p-0 m-1"
                                                        data-item-id="2"
                                                        style="cursor:pointer;">
                                                        <div class="card border-left-primary shadow user-select-none">
                                                            <div class="card-body">
                                    ...
                                    <!-- Traumatic Accident -->
                                    <div class="section-item-trauma" data="required" style="display: none;">
                                        <div class="card shadow">
                                            <div class="card-header">
                                                <h6 class="m-0 font-weight-bold text-primary">Type of Traumatic Accident
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="row  d-flex justify-content-center">

                                                    <div class="trauma-item col-xl-3 col-md-4 col-sm-6 mb-1"
                                                        data-item-id="1"
                                                        style="cursor:pointer;">
                                                        <div class="card border-left-primary shadow user-select-none">
                                                            <div class="card-body">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row no-gutters align-items-center">
                                                                    <div class="col mr-2">
                                                                        <div
                                                                            class="text-xs font-weight-bold text-uppercase mb-1">
                                                                            Gunshot or stab wound victims</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
var informant_number = ""
var informant_time_of_call = ""

var type_of_incident = ""
var type_of_medical_accident = ""
var type_of_traumatic_accident = ""

var responder_team_leader_name = ""
var responder_team_driver_name = ""
var responder_team_member1_name = ""
var responder_team_member2_name = ""
var responder_team_member3_name = ""
var responder_team_member4_name = ""
var responder_team_member5_name = ""
var responder_team_member6_name = ""
var responder_team_member7_name = ""
var responder_team_member8_name = ""

var accident_location_brgy = ""
var accident_location_specific = ""
var accident_date = ""
var accident_time = ""
...
function goForward() {
    ...
    if (c.next().attr('data') == 'required' && type_of_incident == "") {
        $('.btn-next').hide()
    }
