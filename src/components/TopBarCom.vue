...
const { getUser, fullname, getUserDetails, userDetails } = useAccount()
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <RouterLink to="/activities/notifications" class="dropdown-item text-center small text-gray-500" >Show All Alerts</RouterLink>
                </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow mx-1 d-none">
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <RouterLink to="/activities/messages" class="dropdown-item text-center small text-gray-500" >Read More Messages</RouterLink>
                </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ userDetails.firstname + ' ' + userDetails.lastname }}</span>
