            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="incident-type" v-model="form.id" @change="onChange" class="form-select text-muted" :required="true">
                            <option v-for="(itype, i) in itypes" :key="itype.id" :value="itype.id"
                                selected="true">{{ itype.name }}
                            </option>
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-3">
                        <input v-model="form.name" type="text" class="form-control col-sm-12 col-md-3" placeholder="Cause name" aria-label="incident cause name"
                            aria-describedby="button-addon2">
                            <input v-model="form.description" type="text" class="form-control col-sm-12 col-md-9" placeholder="Description" aria-label="incident cause name"
                            aria-describedby="button-addon2">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="(cause, ind) in causes" :key="cause.id">
                                ...
                                <td>
                                    <button :data-id="cause.id" @click="onDelete(cause.id)" id="btnitem" class="btn btn-sm btn-danger d-inline ml-1">
                                        <span>Delete</span>
